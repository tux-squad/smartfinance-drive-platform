...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'financial_entities'
      and policyname = 'Financial entities are viewable by authenticated users'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Vehicles are viewable by owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'vehicles'
      and policyname = 'Vehicles are insertable by owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'vehicles'
      and policyname = 'Vehicles are updatable by owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'vehicles'
      and policyname = 'Vehicles are deletable by owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Simulations are viewable by owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'simulations'
      and policyname = 'Simulations are insertable by owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'simulations'
      and policyname = 'Simulations are updatable by owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'simulations'
      and policyname = 'Simulations are deletable by owner'
  ) then
