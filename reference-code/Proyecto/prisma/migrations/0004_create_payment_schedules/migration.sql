...
create index if not exists payment_schedules_simulation_id_idx
  on public.payment_schedules (simulation_id);

create index if not exists payment_schedules_due_date_idx
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Payment schedules are viewable by simulation owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'payment_schedules'
      and policyname = 'Payment schedules are insertable by simulation owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'payment_schedules'
      and policyname = 'Payment schedules are updatable by simulation owner'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'payment_schedules'
      and policyname = 'Payment schedules are deletable by simulation owner'
  ) then
