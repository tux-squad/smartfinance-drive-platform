...
public record UpdateVehicleResource(
    ...
    public UpdateVehicleResource(UUID financialEntityId, String brand, String model, int manufactureYear, String condition, BigDecimal priceAmount, String currency, String imagePath) {
        this(financialEntityId, brand, model, manufactureYear, condition, priceAmount, currency, imagePath, "ACTIVE", 0, null, null, null, null);
    }
}
